        ...
        const keywordSearch = (obj, query) => {
            if (obj && typeof obj === "object") {
                ...
                if (obj.abilities || obj.gatedAbilities) {
                    ...
                    const inGatedAbilities = obj.gatedAbilities?.some(ability => ability.abilityText?.some(textPart => textPart.type === "keyword" && textPart.value.toLowerCase().includes(query)))
